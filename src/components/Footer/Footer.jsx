      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <div className="flex ">
            ...
            <p className='text-2xl mx-2 text-white'>Fitpro</p>
          </div>
  
          <p className="mt-4 max-w-xs text-gray-400">
          "Empowering Bodies, Inspiring Minds: Your Journey to Fitness Starts Here!"
          </p>
          ...
          <ul className="mt-8 flex gap-6">
            ...
            <li>
              <a
                href="https://www.instagram.com/godxritik/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="https://twitter.com/i/flow/login?redirect_after_login=%2Fgodxritik"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="https://github.com/godxritik/fitpro"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75"
              >

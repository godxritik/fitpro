...
function UserNavbar() 
{
  ...
  return (
    <>
    <div>
      <nav className="bg-transparent border-gray-200 dark:bg-gray-900 overflow-hidden">
        ...
        <a className="px-4 " href="#"><img className="w-[25px]" src={userIcon} alt="" /></a>
           
            <button
              type="button"
              className="text-white bg-transparent border border-white hover:bg-white hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center  dark:hover:bg-blue-700 "
            >
              <a href="/login">Logout</a>
            </button>


            <span className='md:hidden font-semibold' onClick={()=>setSideStatus(!sideStatus)}>&#9776;</span>
          </div>
          ...
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
                  className="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:dark:text-blue-500"
                  aria-current="page"
                >
                  Home
                </a>

...
<div className="w-full p-4 text-center bg-white border border-gray-200  shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 className="my-4 text-3xl font-bold text-gray-900 dark:text-white">Available from anywhere</h5>
    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date with Fitpro on iOS & Android. Download the app today.</p>
